    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="flex flex-col space-y-4 md:col-span-3 md:col-start-11">
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="https://www.instagram.com/r.sahhalevits?igsh=MWdqZjVmdDdqcXZpNw=="
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.facebook.com/people/%D0%A0%D0%BE%D0%BC%D0%B0-%D0%A8%D0%B0%D1%85%D0%B0%D0%BB%D0%B5%D0%B2%D0%B8%D1%87/pfbid02z52zBAhUdghq5a3r7EQecycWk2DgzSpxPqwvRjaok35TwDjrHp9CGh5LmEFLsqgol/#"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 relative">
          <a
            href="https://github.com/Grandapk"
            target="_blank"
            rel="noopener noreferrer"
